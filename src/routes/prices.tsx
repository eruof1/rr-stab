...
const others = [
  {
    model: "Гидравлические шланги высокого давления. Передний контур. На RRS L320",
    detail: "Полный комплект 4 шт. Замена стальных трубок на шланги даёт массу преимуществ: 1. Забываем про ржавчину. 2. Простота замены и дальнейшего обслуживания — не нужно больше снимать кузов или делать дополнительные работы, шланги гибкие и легко прокладываются.",
    price: "29 990 ₽",
    image: l320Hoses.url,
  },
  {
    model: "Гидравлические шланги высокого давления. Задний контур. На RRS L320",
    detail: "Полный комплект 2 шт. Замена стальных трубок на шланги даёт массу преимуществ: 1. Забываем про ржавчину. 2. Простота замены и дальнейшего обслуживания — не нужно больше снимать кузов или делать дополнительные работы, шланги гибкие и легко прокладываются.",
    price: "19 990 ₽",
    image: l320Hoses.url,
  },
  {
    model: "Передний ШРУС заднего кардана на RRS L320",
    detail: "ШРУС часто изнашивается, и появляется люфт. Официально отдельно он не деталируется — предлагается купить весь кардан в сборе. Мы подобрали ШРУС по всем характеристикам и готовы предложить его вам.",
    price: "6 500 ₽",
    image: l320CvJoint.url,
  },
  {
    model: "Оригинальные трубки передний контур RRS L320",
    detail: "Оригинальные металлические трубки ACE на передний контур. В зависимости от мотора и года выпуска были разновидности.",
    price: "от 65 000 ₽",
    image: l320FrontPipes.url,
  },
  {
    model: "Оригинальные трубки задний контур RRS L320",
    detail: "Оригинальные металлические трубки ACE на задний контур.",
    price: "от 35 000 ₽",
    image: l320RearPipes.url,
  },
  {
    model: "Установочные сухари в блок клапанов ACE",
    detail: "Ремкомплект (набор сальников) блока ACE. Подходит как для L320, так и для L405 / L494.",
    price: "от 5 500 ₽",
    image: aceSealKit.url,
  },
];
