...
export const Route = createFileRoute("/advantages")({
  head: () => ({ meta: [{ title: "Преимущества сервиса ReSurse" }, { name: "description", content: "Почему владельцы Range Rover выбирают ReSurse для ремонта активных стабилизаторов." }, { property: "og:title", content: "Преимущества ReSurse" }, { property: "og:description", content: "Опыт, гарантия, обменный фонд и стендовая проверка каждого узла." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary_large_image" }], links: [{ rel: "canonical", href: "/advantages" }] }),
